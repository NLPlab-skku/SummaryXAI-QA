...
class Model(nn.Module): 
    ...
    def forward(self, input_ids=None, attention_mask=None, decoder_input_ids=None, decoder_attention_mask=None, past_key_values = None, use_cache=False, use_prefix=True):
    ...
    def generative_step(self,input_ids=None, max_length=None, min_length=None, num_beams=None, length_penalty=None, no_repeat_ngram_size=None, early_stopping=None):
        # TODO(LISA)
        bsz = input_ids.shape[0]
